...
import { CarEvent, CarInfoEvents } from "../../types";
...
const eventNames: Record<keyof CarInfoEvents, string> = {
  eightMile: "1/8 Mile",
  pops: "Pops & Bangs",
  slalom: "Slalom",
  limbo: "Limbo",
...
const BadgePage = () => {
  ...
  const [badges, setBadges] = useState<Badge[]>([defaultBadge]);
  const badge = badges[selectedIndex] ?? null;
  ...
  const options = useMemo<Options>(
    () => ({
      ...
      data: `https://thecarfest.devbloom.com.co/`,
      qrOptions: {
      ...
      <IonContent>
        <IonItem>
          <IonSelect
            label="Premio"
            value={selectedIndex}
            onIonChange={({ target }) => setSelectedIndex(+target.value)}
          >
            {badges.map((badge, index) => (
              <IonSelectOption key={index} value={index}>
                {badge.event
                  ? `${
                      eventNames[badge.event?.type]
        ...
        <div className={styles.container}>
          ...
          >
            ...
            <g>
              ...
              <path
                className={styles.f}
                d="m173.7,125.68h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m180.38,126.11h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m187.96,125.68h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m195.08,125.68h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m201.76,126.11h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m201.76,277.5h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m151.88,132.99h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m159.45,132.56h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m166.13,132.99h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m173.26,132.99h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m180.83,132.56h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m187.96,132.56h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m194.64,132.99h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m201.76,132.99h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m209.34,132.56h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m216.46,132.56h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m223.59,132.56h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m223.59,270.19h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m144.75,139.87h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m151.88,139.87h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m159,139.87h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m166.13,139.87h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m173.26,139.87h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m180.38,139.87h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m187.51,139.87h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m195.08,139.44h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m202.21,139.44h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m208.89,139.87h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m216.02,139.87h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m223.59,139.44h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m230.27,139.87h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m123.37,160.52h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m251.65,160.52h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m116.24,167.4h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m123.37,167.4h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m252.1,166.97h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m259.22,166.97h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m116.24,174.28h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m123.81,173.85h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m251.65,174.28h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m259.22,173.85h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m116.69,180.73h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m123.81,180.73h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m251.65,181.16h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m258.78,181.16h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m109.56,187.61h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m116.69,187.61h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m123.37,188.04h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m251.65,188.04h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m258.78,188.04h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m265.91,188.04h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m109.11,194.92h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m116.69,194.49h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m123.81,194.49h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m252.1,194.49h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m259.22,194.49h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m266.35,194.49h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m109.11,201.81h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m116.24,201.81h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m123.37,201.81h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m252.1,201.38h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m259.22,201.38h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m266.35,201.38h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m109.56,208.26h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m116.24,208.69h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m123.81,208.26h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m251.65,208.69h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m258.78,208.69h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m266.35,208.26h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m109.11,215.57h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m265.91,215.57h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m116.24,215.57h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m123.37,215.57h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m251.65,215.57h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m259.22,215.14h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m116.69,222.02h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m123.37,222.45h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m252.1,222.02h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m259.22,222.02h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m116.69,228.9h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m123.81,228.9h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m251.65,229.33h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m258.78,229.33h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m116.24,236.21h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m258.78,236.21h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m123.37,236.21h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m251.65,236.21h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m123.37,243.09h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m251.65,243.09h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m145.19,263.31h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m152.32,263.31h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m159,263.74h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m166.58,263.31h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m173.7,263.31h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m180.38,263.74h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m187.96,263.31h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m195.08,263.31h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m201.76,263.74h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m209.34,263.31h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m216.46,263.31h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m223.59,263.31h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m230.72,263.31h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m152.32,270.19h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m159.45,270.19h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m166.58,270.19h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m173.7,270.19h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m180.38,270.62h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m187.96,270.19h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m194.64,270.62h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m201.76,270.62h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m209.34,270.19h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m216.02,270.62h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m173.7,277.07h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m180.83,277.07h-3.56v3.44h3.56v-3.44Z"
              />
              <path
                className={styles.f}
                d="m187.51,277.5h-2.67v2.58h2.67v-2.58Z"
              />
              <path
                className={styles.f}
                d="m194.64,277.5h-2.67v2.58h2.67v-2.58Z"
              />
              <polygon
                className={styles.i}
            ...
            {showBanner && (
              <g transform="translate(24.5,268)">
                ...
                {category && (
                  <text
                    className={styles.h}
                    transform="translate(282.62 64.39)"
                  >
                    <tspan className={styles.t} x="0" y="0">
                      {category}
                    </tspan>
            ...
            <g transform="translate(127,143)" ref={QRRef} />
          </svg>
        </div>
      </IonContent>
    </IonPage>
