      ...
      <IonCardContent>
        <IonText className={styles.card}>
          ...
          <p>
            ...
            cuenta los siguientes requisitos para acceder a las acreditaciones:
          </p>
          ...
          <ol>
            ...
            <li>
              Máximo personas por medio 3 (presentador, camarógrafo y redactor)
            </li>
            <li>Las personas deben ser mayor de edad.</li>
            <li>Datos personales de o las personas inscritas.</li>
            <li>
              Carta donde se certifique existencia del medio y sus integrantes.
            </li>
            ...
            <li>
              ...
              escarapela a cada persona del medio (Nombre de la persona, nombre
              del medio y número de identificación).
            </li>
          </ol>
          <IonCard color="warning">
            <IonCardContent>
              ...
              <i>
                ...
                puede corroborar la información, pidiendo identificación (cedula
                de ciudadanía). En el caso de no ser la persona identificada con
                los datos de la escarapela, se procederá a retirar la escarapela
                y retirar a todo el equipo del medio de prensa del evento.
              </i>
            </IonCardContent>
          </IonCard>
          <p>
            Por favor, leer todos los requisitos y tener lista la documentación
            que se solicita en el formulario antes de empezar a llenarlo.
          </p>
          <br />
          <p>
            Además, es importante tener en cuenta que el proceso de acreditación
            es por cada medio de comunicación. Solo se tendrá en cuenta un
            formulario por cada medio de comunicación. Los datos de las personas
            que se acreditarán deben estar en la carta y, si se envían más
            nombres de los permitidos por tipo de medio, solamente se
            acreditarán las primeras personas del listado. <br />{" "}
